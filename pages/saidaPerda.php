        ...
        <div class="container">
                ...
                <div class="conteudo"> 
                    ...
                    <div class="botoes">
                        <div class="row-buttons">
                            <button class="btn" id="voltar" onclick="showForm('search-saidaPerda-form')"> <i class="fa-solid fa-angle-left"></i> Consultar </button>
            ...
            <div class="form-box" id="search-saidaPerda-form">
                ...
                <div class="conteudo">
                    ...
                    <div class="botoes">
                        <div class="row-buttons">
                            <button class="btn" id="voltar" onclick="showForm('new-saidaPerda-form')"> <i class="fa-solid fa-angle-left"></i> Adicionar </button>
